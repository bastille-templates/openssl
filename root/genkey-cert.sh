...
openssl req -newkey rsa:2048 -days 730 -nodes -keyout /usr/local/etc/ssl/client-key.pem -out /usr/local/etc/ssl/client-req.pem -subj "/C=US/ST=California/L=San Francisco/O=Adminbyaccident Ltd/CN=example.com/emailAddress=youremail@anymail.com"
